...
export const SvgHexDecor = ({
  ...
  return (
    <>
      {hex.terrain === HexTerrain.snow && <SvgSnowSnowflake isSubLevel={isSubLevel} />}
      {hex.terrain === HexTerrain.ice && <SvgIceSnowflake isSubLevel={isSubLevel} />}
      {hex.terrain === HexTerrain.road && <SvgRoadCobblestone isSubLevel={isSubLevel} />}
      {hex.terrain === HexTerrain.wallWalk && <SvgRoadCobblestone isSubLevel={isSubLevel} />}
      {hex.terrain === HexTerrain.toxic && <SvgToxicNuclear isSubLevel={isSubLevel} />}
      {hex.terrain === HexTerrain.toxicWater && <SvgToxicNuclear isToxicWater isSubLevel={isSubLevel} />}
    </>
  )
}
...
export const SvgIceSnowflake = ({
  isSubLevel,
}: {
  isSubLevel?: boolean
}) => {
  const fillColor = isSubLevel
    ? svgSubLevelColors.iceDecor
    : svgColors.iceDecor
  return (
    <>
      <g transform={`scale(${.105 * SVG_HEX_RADIUS}) translate(-28.7, -1074.2)`}>
...
export const SvgRoadCobblestone = ({
  isSubLevel,
}: {
  isSubLevel?: boolean
}) => {
    ...
    <>
      <g transform={`translate(${roadDecorScale * -28.812}, ${roadDecorScale * -2038.11}) scale(${roadDecorScale})`}>
        ...
        <path d="M29.4454 2038.67C29.2523 2038.42 28.9046 2037.32 28.9355 2037C28.951 2036.8 29.4995 2035.58 29.6385 2035.5C29.8162 2035.39 30.6737 2035.3 30.9209 2035.3C31.2145 2035.3 31.9948 2035.4 32.242 2035.53C32.5201 2035.66 33.254 2036.67 33.2308 2036.98C33.2231 2037.1 32.5741 2038.47 32.466 2038.64C31.9407 2039.48 31.5312 2039.1 30.7742 2038.99C30.3338 2038.93 29.7853 2039.1 29.4454 2038.67Z"
          fill={fillColor} />
        <path d="M26.7569 2034.12C27.0273 2034.07 28.1397 2034.06 28.3946 2034.12C28.6882 2034.19 29.0899 2034.79 29.0667 2035.11C29.0281 2035.63 28.4719 2036.8 27.9234 2036.81C27.6685 2036.81 26.9423 2036.76 26.6796 2036.72C25.9998 2036.62 26.2547 2036.23 26.2316 2035.79C26.1929 2035.18 25.9303 2034.27 26.7646 2034.12L26.7569 2034.12Z"
          fill={fillColor} />
        <path d="M30.6574 2039.38C30.9742 2039.34 32.0248 2039.71 32.2643 2039.94C32.8978 2040.57 32.3956 2041.79 31.6154 2041.86C31.1364 2041.9 30.0781 2041.46 29.6532 2041.19C29.2514 2040.94 29.2128 2040.39 29.4909 2040C29.6454 2039.79 30.418 2039.41 30.6574 2039.38V2039.38Z"
          fill={fillColor} />
      </g>
    </>
  )
}
export const SvgToxicNuclear = ({
  isSubLevel,
  isToxicWater
}: {
  isSubLevel?: boolean
  ...
  const fillColor = isToxicWater && isSubLevel
    ? svgSubLevelColors.toxicWaterDecor
    : isToxicWater ? svgColors.toxicWaterDecor
      : isSubLevel ? svgSubLevelColors.toxicLandDecor
