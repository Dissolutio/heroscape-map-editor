import { Button, Dialog, DialogActions, DialogContent, DialogTitle, useMediaQuery, Box, Typography, TextField, Divider } from "@mui/material"
...
export const EditPieceInventoryDialog = () => {
  ...
  const userPieceInventory = useBoundStore(
    (state) => state.userPieceInventory,
  )
  ...
  const [localInventory, setLocalInventory] = useState<PieceInventory>(userPieceInventory || { ...blankPieceInventory })
