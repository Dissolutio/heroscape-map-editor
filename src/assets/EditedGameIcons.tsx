  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0%" stopColor="#3d6a7b" stopOpacity="1" />
          <stop offset="100%" stopColor="#2f5360" stopOpacity="1" />
        </linearGradient>
        ...
        <linearGradient id="skoll-hexes-gradient-17">
          <stop offset="0%" stopColor="#9b9b9b" stopOpacity="1" />
          <stop offset="100%" stopColor="#00a100" stopOpacity="1" />
        </linearGradient>
        <linearGradient
          x1="0"
          x2="1"
