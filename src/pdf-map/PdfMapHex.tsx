import { Ellipse, G, Path, Text } from '@react-pdf/renderer'
...
// const PdfSnowDecor = ({ terrain }: { terrain: string }) => {
//   return (
//     <Path
...
//   )
// }
// const PdfRoadDecor = ({ terrain }: { terrain: string }) => {
const PdfRoadDecor = () => {
  return (
    <>
      ...
      <Path
        style={{
          transform: 'translate(-22,17),scale(0.25),rotate(40)',
        }}
        fill="black"
      ...
      <Path
        style={{
          transform: 'translate(13,-18),scale(0.25),rotate(160)',
        }}
        fill="black"
      ...
      <Path
        style={{
          transform: 'translate(-15,-22),scale(0.19),rotate(70)',
        }}
        fill="black"
      ...
      <Path
        style={{
          transform: 'translate(17,18),scale(0.17),rotate(220)',
        }}
        fill="black"
