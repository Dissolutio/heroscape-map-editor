    ...
    <>
      ...
      {(hex.terrain === HexTerrain.snow || hex.terrain === HexTerrain.ice) && (
        <Path
          ...
          transform={`translate(${-3 * SVG_HEX_APOTHEM}, ${-2 * SVG_HEX_RADIUS})translate(${-2 * SVG_HEX_APOTHEM}, ${-2 * SVG_HEX_RADIUS})scale(0.2)translate(${2 * SVG_HEX_APOTHEM}, ${2 * SVG_HEX_RADIUS})`}
        ></Path>
      )}
    </>
  )
