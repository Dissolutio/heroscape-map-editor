...
export const SVG_BORDER_WIDTH = SVG_HEX_RADIUS * 0.3046303818 // per AllMapTiles/1hex-new.svg, hex radius is 8.348, stroke width is 3, so half stroke is 1.5, stroke is half-in half-out, 8.348 + 1.5 = 9.848,  3 / 9.848 = 0.3046303818
...
export const SVG_TREE_JUNGLE_OUTCROP_BORDER_WIDTH = SVG_HEX_RADIUS * 0.2016129030 // per AllMapTiles/1hex-new.svg hex radius is 8.92, stroke width is 2, so half stroke is 1, stroke is half-in half-out, 8.92 + 1 = 9.92,  2 / 9.92 = 0.2016129030
export const SVG_LAUR = SVG_HEX_RADIUS * 0.2016129030 // per AllMapTiles/1hex-new.svg hex radius is 8.92, stroke width is 2, so half stroke is 1, stroke is half-in half-out, 8.92 + 1 = 9.92,  2 / 9.92 = 0.2016129030
