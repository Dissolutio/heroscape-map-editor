...
export const SVG_BORDER_WIDTH = SVG_HEX_RADIUS * 0.35936751317 // per AllMapTiles/1hex-new.svg
export const SVG_EMPTYHEX_BORDER_WIDTH = SVG_HEX_RADIUS * 0.19841269841 // per AllMapTiles/GridBG.svg
export const OPACITY_EMPTY = 1
