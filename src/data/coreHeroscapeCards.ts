...
const valhallaCustomHeroscapeCards: ICoreHeroscapeCard[] = [
  {
    name: 'Omegacron',
    singleName: 'Omegacron',
    armyCardID: 'hsVc1000',
    image: '',
    portraitPattern: '',
    general: 'jandar',
    ...
    figures: '1',
    hexes: '2',
    setWave: "Wave 14: Thormun's Reprieve",
    abilities: [
      {
        name: 'Double Attack',
        desc: 'When Omegacron attacks, he may attack one additional time.',
      },
      {
        name: 'Omnicron Mobilization',
        desc: 'Instead of moving with Omegacron, you may move up to 3 other Soulborg figures you control who follow Jandar up to 5 spaces each.',
      },
      {
        name: 'Directed Fire',
        desc: 'Instead of attacking with Omegacron this turn, you may choose up to 3 unengaged Soulborg Squad figures you control who follow Jandar. Take a single turn with the chosen figures, during which the chosen figures may only attack. Omegacron must also have line of sight to any figure attacked using Directed Fire.',
      },
    ],
  },
]
