...
export default function MapDisplay3D({
  ...
  const [transformControlsVisible, setTransformControlsVisible] = useState(false);
  const [selectedObject, setSelectedObject] = useState(null);
  const [transformMode, setTransformMode] = useState<'translate' | 'rotate' | 'scale'>('translate'); // 'translate', 'rotate', 'scale'
